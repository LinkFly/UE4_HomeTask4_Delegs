...
AUE4_HomeTask4_DelegsHud::AUE4_HomeTask4_DelegsHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AUE4_HomeTask4_DelegsHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		AUE4_HomeTask4_DelegsPawn* Vehicle = Cast<AUE4_HomeTask4_DelegsPawn>(GetOwningPawn());
